...
data class WalletHomeUiState(
    ...
    val totalPortfolioValueText: String = "$0.00",
    val priceUpdatedLabel: String = "",
...
fun walletHomePreviewState(): WalletHomeUiState = WalletHomeUiState(
    ...
    assets = listOf(
        AssetHolding("ethereum:native:ETH", "ETH", "Ethereum", "2.84 ETH", "$9,214.80", "$3,244.65", "+2.4%", true),
        AssetHolding("tron:native:USDT", "USDT", "TRON", "12,450 USDT", "$12,450.00", "$1.00", "0.0%", true),
        AssetHolding("polygon:native:MATIC", "MATIC", "Polygon", "1,202 MATIC", "$1,103.24", "$0.92", "+6.1%", true),
        AssetHolding("arbitrum:native:ARB", "ARB", "Arbitrum", "856 ARB", "$1,202.84", "$1.40", "-3.4%", false),
        AssetHolding("solana:native:SOL", "SOL", "Solana", "9.8 SOL", "$1,860.44", "$189.84", "+4.7%", true),
        AssetHolding("bsc:native:BNB", "BNB", "BSC", "1.2 BNB", "$685.10", "$570.92", "+1.3%", true),
    ),
    totalPortfolioValueText = "$26,515.42",
    priceUpdatedLabel = "价格更新于刚刚",
