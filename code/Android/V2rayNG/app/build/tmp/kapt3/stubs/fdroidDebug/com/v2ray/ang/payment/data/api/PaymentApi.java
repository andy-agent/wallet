...
public abstract interface PaymentApi {
    ...
    @retrofit2.http.POST(value = "api/client/v1/orders/{orderNo}/submit-client-tx")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object submitClientTx(@retrofit2.http.Header(value = "Authorization")
    @org.jetbrains.annotations.NotNull()
    java.lang.String authorization, @retrofit2.http.Path(value = "orderNo")
    @org.jetbrains.annotations.NotNull()
    java.lang.String orderNo, @retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    com.v2ray.ang.payment.data.api.SubmitClientTxRequest request, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.v2ray.ang.payment.data.api.OperationResponse>> $completion);
    
    @retrofit2.http.POST(value = "api/client/v1/orders/{orderNo}/refresh-status")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object refreshOrderStatus(@retrofit2.http.Header(value = "Authorization")
    @org.jetbrains.annotations.NotNull()
    java.lang.String authorization, @retrofit2.http.Path(value = "orderNo")
    @org.jetbrains.annotations.NotNull()
    java.lang.String orderNo, @retrofit2.http.Body()
    @org.jetbrains.annotations.NotNull()
    com.v2ray.ang.payment.data.api.RefreshOrderStatusRequest request, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.v2ray.ang.payment.data.model.GetOrderResponse>> $completion);
