...
public final class RulesetItem {
    ...
    @org.jetbrains.annotations.Nullable()
    private java.util.List<java.lang.String> protocol;
    private boolean enabled;
    @org.jetbrains.annotations.Nullable()
    private java.lang.Boolean locked;
    
    public RulesetItem(@org.jetbrains.annotations.Nullable()
    java.lang.String remarks, @org.jetbrains.annotations.Nullable()
    java.util.List<java.lang.String> ip, @org.jetbrains.annotations.Nullable()
    java.util.List<java.lang.String> domain, @org.jetbrains.annotations.NotNull()
    ...
    java.util.List<java.lang.String> protocol, boolean enabled, @org.jetbrains.annotations.Nullable()
    ...
    @org.jetbrains.annotations.Nullable()
    public final java.util.List<java.lang.String> getIp() {
        return null;
    }
    ...
    @org.jetbrains.annotations.Nullable()
    public final java.util.List<java.lang.String> getDomain() {
        return null;
    }
    ...
    public final void setLocked(@org.jetbrains.annotations.Nullable()
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.v2ray.ang.dto.RulesetItem copy(@org.jetbrains.annotations.Nullable()
    java.lang.String remarks, @org.jetbrains.annotations.Nullable()
    java.util.List<java.lang.String> ip, @org.jetbrains.annotations.Nullable()
    java.util.List<java.lang.String> domain, @org.jetbrains.annotations.NotNull()
    java.lang.String outboundTag, @org.jetbrains.annotations.Nullable()
